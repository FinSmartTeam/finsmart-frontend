  ...
  return (
    <div className="min-h-screen bg-base-dark text-text-mainDark font-sans selection:bg-primary selection:text-white">
      ...
      <nav className="px-6 py-5 flex justify-between items-center sticky top-0 bg-base-dark/70 backdrop-blur-xl z-50 border-b border-white/5">
        ...
        <img src={logo} alt="FinSmart Logo" className="h-8 object-contain" />
      ...
      <header className="px-6 pt-16 pb-24 text-center space-y-10 relative overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm text-text-mutedDark leading-relaxed max-w-70 mx-auto font-medium">
        ...
        <button 
          onClick={onStart}
          className="w-full max-w-70 bg-primary text-white font-black py-4.5 rounded-2xl shadow-[0_15px_35px_rgba(22,128,255,0.3)] active:scale-95 transition-all uppercase tracking-widest text-xs cursor-pointer"
        >
          Mulai Sekarang
        </button>
      </header>
      ...
      <footer className="px-10 py-16 bg-card-dark/80 border-t border-white/5 text-center space-y-10">
        ...
        <div className="space-y-4 pt-4 flex flex-col items-center">
          {/* Logo Footer */}
          <img src={logo} alt="FinSmart Logo" className="h-6 object-contain opacity-50 grayscale" />
          <p className="text-[9px] text-text-mutedDark font-medium tracking-widest uppercase mt-2">
